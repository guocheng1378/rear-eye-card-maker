...
var COMMANDS = [
  ...
  { id: 'gridArrange', icon: '⊞', label: '网格排列 (2列)', shortcut: '', category: '元素', fn: function (c) { c.arrangeGrid(2, 10, 10); } },
  { id: 'gridArrange3', icon: '⊟', label: '网格排列 (3列)', shortcut: '', category: '元素', fn: function (c) { c.arrangeGrid(3, 8, 8); } },
  { id: 'pickColor', icon: '🎨', label: '取色器', shortcut: '', category: '工具', fn: function (c) { c.pickColor(function(color) { toast('🎨 ' + color, 'success'); }); } },
